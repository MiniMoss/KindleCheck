...
ActiveRecord::Schema.define(version: 20150518091137) do
  ...
  create_table "dics", force: :cascade do |t|
    t.string   "word",           limit: 255
    t.string   "createdtime",    limit: 255
    t.string   "book",           limit: 255
    t.string   "author",         limit: 255
    t.string   "language",       limit: 255
    t.string   "usage",          limit: 255
    t.string   "translation",    limit: 255
    t.string   "basic_explains", limit: 255
